...
#-------------------------------------------------------------------------------
def ow_sprite_filename_with_water(x, y, species, form = 0, gender = 0, shiny = false, shadow = false)
  ...
  fname = GameData::Species.check_graphic_file("Graphics/Characters/", params, "Levitates Shiny") if water_tile and shiny and nil_or_empty?(fname)
  fname = GameData::Species.check_graphic_file("Graphics/Characters/", params, "Swimming") if water_tile and nil_or_empty?(fname)
